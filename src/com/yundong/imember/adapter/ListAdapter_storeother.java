 ...
 *
 */
public class ListAdapter_storeother extends ArrayAdapter<Store> {
	...
	public ListAdapter_storeother(Context context, ListView listView) {
		super(context, 0);
	...
	public int getCount() {
		...
		return ImemberApplication.getInstance().stores_other.size();
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Store store = ImemberApplication.getInstance().stores_other.get(position);
